...
export type FieldValidator<TPropertyType, T> 
= TPropertyType extends string 
    ? StringValidator<T>
    : TPropertyType extends number
    ? NumberValidator<T> : any;
...
export type ValidationAction = <TModel, TArgument extends any = {}>(model: TModel, propertyName: string, args?:   TArgument) => FieldValidationResult;
